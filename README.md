...
Three Agent Skills built for Claude, each focused on a real part of event-marketing work: defending a budget, deciding whether to buy or rent, and getting a team ready before an event. Every Skill is self-contained — a `SKILL.md` that tells Claude when and how to use it, along with any supporting references and scripts.
...
*Inside:* a single self-contained `SKILL.md`.
